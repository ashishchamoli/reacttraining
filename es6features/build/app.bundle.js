...
var COL_SEPARATOR = ',';
var ORDER_SYMBOL = Symbol("Order Symbol");
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.prev = 3;
                            _iterator = this[ORDER_SYMBOL][Symbol.iterator]();
...
var _internetcustomer = __webpack_require__(122);

var _customer = __webpack_require__(86);

var _order2 = __webpack_require__(87);

var _valueprovider = __webpack_require__(88);

var _valueanalyzer = __webpack_require__(124);

var _arrowfunctions = __webpack_require__(120);

var _withoutpromises = __webpack_require__(125);

var _withpromises = __webpack_require__(126);
...
anotherCustomer.addOrder(new _order2.Order(2, new Date(), 12000));
anotherCustomer.addOrder(new _order2.Order(3, new Date(), 12000));
anotherCustomer.addOrder(new _order2.Order(4, new Date(), 12000));
...
var analyzer = new _valueanalyzer.ValueAnalyzer(1, 2, 3, 4, 5);
var analyzedValues = analyzer.getValues();
...
var heavyWorker1 = new PromiseWorkers.HeavyWorker();
var heavyWorker2 = new PromiseWorkers.HeavyWorker2();

var input = 200;

Promise.all([heavyWorker1.process(input), heavyWorker2.process(input)]).then(function (data) {
    return console.log('Both successfully completed ..' + JSON.stringify(data));
}, function (error) {
    return console.log('One fo the workers failed ..' + JSON.stringify(error));
});
...
var InternetCustomer = function (_Customer) {
    ...
    _createClass(InternetCustomer, [{
        key: 'format',
        value: function format() {
            var formattedMessage = _formatutils.ObjectFormatter.format(this);
...
function processOrder(order) {
    ...
    if (order.amount >= 1000) console.log('Order Status : PROCESSED');else console.log('Order Status : ON-HOLD');
...
processOrder = new Proxy(processOrder, {
    apply: function apply(target, currentHandler, args) {
        var alreadyProcessedOrders = ['ORD10001', 'ORD10002', 'ORD10003'];
...
exports.ValueAnalyzer = undefined;
...
var ValueAnalyzer = function (_ValueProvider) {
    _inherits(ValueAnalyzer, _ValueProvider);

    function ValueAnalyzer() {
        _classCallCheck(this, ValueAnalyzer);

        return _possibleConstructorReturn(this, (ValueAnalyzer.__proto__ || Object.getPrototypeOf(ValueAnalyzer)).apply(this, arguments));
    }

    _createClass(ValueAnalyzer, [{
        key: 'getValues',
        value: function getValues() {
            var processedMessages = _get(ValueAnalyzer.prototype.__proto__ || Object.getPrototypeOf(ValueAnalyzer.prototype), 'getValues', this).call(this);

            return processedMessages.map(function (item) {
                return item * item;
            });
        }
    }]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(117), __webpack_require__(309)(module)))
